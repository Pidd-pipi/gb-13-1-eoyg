...
- 按学科分类浏览
- 卖家主动联系买家
- 求购报价协商：求购进行中时，其他用户（卖家）可提交报价（价格、成色、取书地点、失效时间）
- 同一卖家重提自动更新原报价，每个求购最多保留 3 条待选报价
- 发布者确认一条报价后，求购关闭且其余报价一同落选；支持卖家撤回报价
- 失效、撤回、落选等非待选报价不能确认，重复或并发确认仅成功一次
- 求购详情展示报价数量、卖家、状态与失败原因，下拉刷新可回读
